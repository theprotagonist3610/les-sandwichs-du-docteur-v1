...
DROP POLICY IF EXISTS "config_prix_insert" ON config_prix_produits;
DROP POLICY IF EXISTS "config_prix_update" ON config_prix_produits;
DROP POLICY IF EXISTS "config_prix_delete" ON config_prix_produits;

CREATE POLICY "config_prix_insert"
ON config_prix_produits
FOR INSERT
TO authenticated;

CREATE POLICY "config_prix_update"
ON config_prix_produits
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "config_prix_delete"
ON config_prix_produits
FOR DELETE
TO authenticated
USING (
...
DROP POLICY IF EXISTS "distributeurs_insert" ON distributeurs_eligibles;
DROP POLICY IF EXISTS "distributeurs_update" ON distributeurs_eligibles;
DROP POLICY IF EXISTS "distributeurs_delete" ON distributeurs_eligibles;

CREATE POLICY "distributeurs_insert"
ON distributeurs_eligibles
FOR INSERT
TO authenticated;

CREATE POLICY "distributeurs_update"
ON distributeurs_eligibles
FOR UPDATE
TO authenticated
USING (
...
CREATE POLICY "distributeurs_delete"
ON distributeurs_eligibles
FOR DELETE
TO authenticated
USING (
