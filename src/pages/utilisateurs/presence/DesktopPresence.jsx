                  ...
                  {inactiveUsers.length === 0 && preUsers.length === 0 ? (
                    ...
                    <>
                      ...
                      {preUsers.map((preUser) => (
                        <div
                          key={`pre-${preUser.id}`}
                          className="w-full flex items-center gap-3 p-2 rounded-lg bg-accent/30">
                          {/* Avatar */}
                          <Avatar className="w-8 h-8">
                      ...
                      {inactiveUsers.map((user) => (
                        <button
                          key={user.id}
                          onClick={() => handleUserClick(user.id)}
                          className="w-full flex items-center gap-3 p-2 rounded-lg hover:bg-accent transition-colors opacity-60">
                          {/* Avatar */}
                          <Avatar className="w-8 h-8">
                            <AvatarImage src={user.photo_url} alt="Avatar" />
                            <AvatarFallback className="bg-primary/10 text-primary text-xs font-semibold">
