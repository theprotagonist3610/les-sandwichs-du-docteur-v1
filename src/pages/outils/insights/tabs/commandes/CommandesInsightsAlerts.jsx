/**
 * CommandesInsightsAlerts.jsx
 * Alertes textuelles dérivées de l'analyse commandes.
 * Même structure que FinanceInsightsAlerts.
 */
...
const CommandesInsightsAlerts = ({ analysis }) => {
...
export default CommandesInsightsAlerts;
