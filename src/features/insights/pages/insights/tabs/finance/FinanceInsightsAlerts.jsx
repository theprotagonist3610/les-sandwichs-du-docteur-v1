/**
 * FinanceInsightsAlerts.jsx
 * Insights textuels dérivés de l'analyse financière.
 * Affiche les alertes produites par FinanceInsightsEngine.buildAlertes()
 */
...
const FinanceInsightsAlerts = ({ analysis }) => {
...
export default FinanceInsightsAlerts;
