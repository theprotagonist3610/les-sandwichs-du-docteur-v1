...
import { Tabs as TabsInner, TabsContent as TabsContentInner, TabsList as TabsListInner, TabsTrigger as TabsTriggerInner } from "@/shared/components/ui/tabs";
import taskToolkit from "@/features/dashboard/utils/taskToolkit";
            ...
            <TabsContent value="journal" className="space-y-4 mt-6">
              {isLoadingJournal ? (
                ...
                <div className="text-center py-12 text-muted-foreground">
                  ...
                  <p className="text-lg">Aucune connexion enregistrée</p>
                </div>
              ) : (
              ...
              <Dialog open={openDialog} onOpenChange={setOpenDialog}>
                ...
                <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Créez une nouvelle tâche ou assignez-vous une tâche existante
                    </DialogDescription>
                  </DialogHeader>

                  <TabsInner defaultValue="create" className="w-full mt-4">
                    <TabsListInner className="grid w-full grid-cols-2">
                      <TabsTriggerInner value="create">Créer</TabsTriggerInner>
                      <TabsTriggerInner value="assign">S'assigner</TabsTriggerInner>
                    </TabsListInner>

                    {/* Onglet Créer une nouvelle tâche */}
                    <TabsContentInner value="create" className="space-y-4 mt-4">
                    ...
                    <TabsContentInner value="assign" className="space-y-4 mt-4">
                      {isLoadingDisponibles ? (
                        ...
                        <div className="text-center py-12 text-muted-foreground">
                          ...
                          <p className="text-lg">Aucune tâche disponible</p>
                        </div>
                      ) : (
